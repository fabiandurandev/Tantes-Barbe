  ...
  return (
    ...
    <Box p={6} maxW="4xl" mx="auto" textAlign="center">
      ...
      <HStack spacing={20} justify="center">
        ...
        <Text fontWeight="bold" fontSize="lg">AGREGAR NUEVO PROVEEDOR</Text>
        </VStack>
        ...
        <Text fontWeight="bold" fontSize="lg">MODIFICAR PROVEEDOR</Text>
        </VStack>
        ...
        <Text fontWeight="bold" fontSize="lg">CONSULTAR PROVEEDOR</Text>
        </VStack>
      </HStack>
    </Box>
    </Flex>
