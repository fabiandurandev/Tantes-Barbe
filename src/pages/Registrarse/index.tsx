...
import {
  registrarseSchema,
  type registrarseSchemaType,
} from "./schemaRegistrarse";
...
export default function RegistrarsePage() {
  ...
  const { mutate } = UseRegistrarUsuario();

  const onSubmit = async (data: registrarseSchemaType) => {
