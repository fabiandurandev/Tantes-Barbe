  ...
  return (
    ...
    <Box p={6} maxW="4xl" mx="auto" textAlign="center">
      ...
      <HStack spacing={20} justify="center">
        ...
        <Text fontWeight="bold" fontSize="lg">AGREGAR NUEVA COMPRA</Text>
        </VStack>
        ...
        <Text fontWeight="bold" fontSize="lg">ANULAR COMPRA</Text>
        </VStack>
        ...
        <Text fontWeight="bold" fontSize="lg">CONSULTAR COMPRA</Text>
        </VStack>
      </HStack>
    </Box>
    </Flex>
